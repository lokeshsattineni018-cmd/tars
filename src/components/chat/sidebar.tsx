...
export function Sidebar() {
    ...
    return (
        <div className="flex h-full w-full flex-col transition-all duration-300 relative border-r border-zinc-200/50 dark:border-zinc-800/50 bg-white/80 dark:bg-black/40 backdrop-blur-md">
