...
export function ChatHeader({ conversationId }: { conversationId: Id<"conversations"> }) {
    ...
    return (
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 p-4 z-30 w-full flex-shrink-0 transition-colors duration-300 border-b border-zinc-200/50 dark:border-zinc-800/50 bg-white/80 dark:bg-black/40 backdrop-blur-md">
